    ...
    static let prologueScenes: [StoryScene] = [
        ...
        StoryScene(
            ...
            lines: [
                ...
                .narrator("He pulls a book from the shelf. Leather-bound."),
                .narrator("The cover shows a sword thrust into a stone. The title, in faded gold: THE ONCE AND FUTURE KING."),
                DialogueLine(speakerName: "Shopkeeper", speakerPortrait: PortraitRegistry.shopkeeperPortrait,
